...
A phase transition in SI-ADX correlation occurs around 30 days: the correlation is negative at short horizons ($r = -0.05$ at 3--7 days) but positive at long horizons ($r = +0.35$ at 30--120 days). This is consistent with the time required for replicator affinities to accumulate meaningful structure. See supplementary Figure S2 for detailed visualization.
